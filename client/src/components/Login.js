...
const Login = ({ onLogin }) => {
  ...
  const handlePhoneSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://loancopy-production.up.railway.app/api/auth/send-otp', {
        method: 'POST',
        headers: {
  ...
  const handleOtpSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://loancopy-production.up.railway.app/api/auth/verify-otp', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
